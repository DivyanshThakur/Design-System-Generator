...
exports.getThemeById = exports.updateThemeById = exports.getAllThemes = exports.createTheme = void 0;
 ...
 * @access Private
 */
exports.getAllThemes = (0, protectedHandler_1.protectedHandler)(async (req, res) => {
    const userId = res.locals.userId;
    const projectId = req.params.projectId;
 ...
 * @access Private
 */
exports.updateThemeById = (0, protectedHandler_1.protectedHandler)(async (req, res) => {
    const userId = res.locals.userId;
    const projectId = req.params.projectId;
    const themeId = req.params.id;
    const theme = await Theme_1.default.findOneAndUpdate({ _id: themeId, userId, projectId }, {}, { returnOriginal: false });
    res.json({
        success: true,
        data: theme,
 ...
 * @access Private
 */
exports.getThemeById = (0, protectedHandler_1.protectedHandler)(async (req, res) => {
    const userId = res.locals.userId;
    const projectId = req.params.projectId;
    const themeId = req.params.id;
    const theme = await Theme_1.default.findOne({ _id: themeId, projectId, userId });
    res.json({
        success: true,
        data: theme,
        message: 'Theme fetched successfully',
